...
import com.alisha.sentinel.SentinelJedis;
...
@SpringBootApplication(scanBasePackages = "com.alisha")
public class RedisSentinelApplication {
	...
	public static void main(String[] args) {
		...
		RedisSentinelApplication redisApplication = new RedisSentinelApplication();
